...
fn main() {
    ...
    let checked_in =
        fs::read_to_string(root.join("src/generated.rs")).expect("read checked-in Signal Rust");
    assert_eq!(
        generated, checked_in,
        "checked-in Signal Rust is stale; regenerate src/generated.rs before building"
    );
}
