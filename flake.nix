{
  description = "signal-lojix — generated ordinary Lojix Signal contract";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        checks = {
          ...
          no-free-functions = pkgs.runCommand "signal-lojix-no-free-functions" { inherit src; } ''
            ${builtins.readFile ./checks/no-free-functions.sh}
          '';
          no-inherent-methods = pkgs.runCommand "signal-lojix-no-inherent-methods" { inherit src; } ''
